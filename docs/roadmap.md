...
1. Base do projeto
   ...
   - Definir AST, tipos, erros e testes de sanidade para cada marco implementado.

2. Analise lexica e sintatica
   - Ainda nao implementada neste marco.
...
3. Sistema de tipos
   - Implementado neste marco sobre a AST em TypeScript, sem depender de parser.
...
4. Avaliador small-step
   - Ainda nao implementado neste marco.
